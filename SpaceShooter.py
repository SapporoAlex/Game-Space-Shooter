...
destroy_sound = pygame.mixer.Sound("assets/destroy.mp3")
next_level_sound = pygame.mixer.Sound("assets/next_level.mp3")
damaged_sound = pygame.mixer.Sound("assets/damaged.mp3")
...
def main():
    ...
    lost_font = pygame.font.SysFont("impact", 90)
